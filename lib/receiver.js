function PeerReceiver (id, socket, dom, options) {
  ...
  this._dc = this._pc.createDataChannel('', { reliable: this._options.reliable });
...
PeerReceiver.prototype._configureDataChannel = function() {
  ...
  this._dc.onmessage = function(e) {
    self._handleDataMessage(e, function(data){
      ...
      switch(data[0]){
        case 0:
          var chunk = self._dom(data[1][0], data[1][2], data[1][3]);
          if (chunk) {
...
PeerClient.prototype._handleDataMessage = function(e, cb) {
  var self = this;
  var data = e.data;
