...
DomManager.prototype.read = function(url, start, end) {
  // Reads from cache and/or local storage for the file starting at start byte and ending with end byte.
  // return false if file non existent.
}

DomManager.prototype.write = function(url, data) {
  // Writes to dom element with url using data chunk.
}
